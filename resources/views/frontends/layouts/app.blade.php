                        ...
                        <div data-w-id="ca66c9a1-6754-411c-5d58-64c2b94ef88e" style="-webkit-transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="home1_hero_grid">
                            <div class="home1_hero_content">
                                <div>
                                    ...
                                    <div class="home1_hero_reviews">
                                        <div class="home1_hero_reviews-authors">
                                            <img loading="lazy" src="{{ asset('asset_frontend') }}/images/6836a1f2a7daec0f92e75f70_avatar1.avif" alt="B2B SaaS software Webflow template avatar1" class="home1_hero_image-2 is-first"/>
                                            <img loading="lazy" src="{{ asset('asset_frontend') }}/images/6836a1f22ac72e90bfe31d43_avatar2.avif" alt="B2B SaaS software Webflow template avatar2" class="home1_hero_image-2"/>
                                            <img loading="lazy" src="{{ asset('asset_frontend') }}/images/6836a1f24eeba9f6eea60515_avatar4.avif" alt="B2B SaaS software Webflow template avatar4" class="home1_hero_image-2"/>
                                        </div>
                                        <img loading="lazy" src="{{ asset('asset_frontend') }}/images/68369fedfa0b25a3fec6d9f3_reviews%20start.png" alt="5 Stars" class="home1_hero_reviews-stars"/>
                                ...
                                <a href="#" class="home1_hero_lightbox w-inline-block w-lightbox">
                                    <div data-poster-url="{{ asset('asset_frontend') }}/images%2F6836a28bd68c9a29a6160ae4_Untitled%20design%20%284%29-poster-00001.jpg" data-video-urls="{{ asset('asset_frontend') }}/images%2F6836a28bd68c9a29a6160ae4_Untitled%20design%20%284%29-transcode.mp4,{{ asset('asset_frontend') }}/images%2F6836a28bd68c9a29a6160ae4_Untitled%20design%20%284%29-transcode.webm" data-autoplay="true" data-loop="true" data-wf-ignore="true" class="home1_hero_video w-background-video w-background-video-atom">
                                        <video id="a74ced63-dc72-71c7-dc2b-a53869f694c7-video" autoplay="" loop="" style="background-image:url(&quot;{{ asset('asset_frontend') }}/images%2F6836a28bd68c9a29a6160ae4_Untitled%20design%20%284%29-poster-00001.jpg&quot;)" muted="" playsinline="" data-wf-ignore="true" data-object-fit="cover">
                            ...
                            <div class="home1_hero_image-box">
                                ...
                                {{ asset('asset_frontend') }}/images/6836a2c1edfbcae728f8a3ca_dashboard-p-500.avif 500w, 
                                {{ asset('asset_frontend') }}/images/6836a2c1edfbcae728f8a3ca_dashboard-p-800.avif 800w, 
                                {{ asset('asset_frontend') }}/images/6836a2c1edfbcae728f8a3ca_dashboard.avif 1446w" alt="B2B SaaS software Webflow template dashboard" class="home1_hero_image"/>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="padding-global padding-section-small">
                        <div class="container-default">
                            ...
                            <div data-w-id="9faa6f1a-38c0-72ae-3a77-972386a2669e" style="-webkit-transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 1.5rem, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="home1_benefits_grid">
                                <img src="{{ asset('asset_frontend') }}/images/6836a7256bd97f5e18662d0a_main%20hero1.avif" loading="lazy" id="w-node-_97fbcd01-05f4-4cf2-b6ae-bb7b5204ad5e-4f6e2f6e" alt="B2B SaaS software Webflow template hero1" class="home1_benefits_image"/>
                                <div class="home1_benefits_card">
                                    <img src="{{ asset('asset_frontend') }}/images/6836a7c565523b582b2e3b55_benefits%20icon1.avif" loading="lazy" alt="B2B SaaS software Webflow template benefits 1" class="icon-height-huge"/>
                                    <div class="spacer-medium"></div>
                                    <div>
                                ...
                                <div class="home1_benefits_card">
                                    <img src="{{ asset('asset_frontend') }}/images/6836a7c50e1c44ae750f9198_benefits%20icon2.avif" loading="lazy" alt="B2B SaaS software Webflow template benefits 2" class="icon-height-huge"/>
                                    <div class="spacer-medium"></div>
                                    <div>
                                ...
                                <div class="home1_benefits_card">
                                    <img src="{{ asset('asset_frontend') }}/images/6836a7c53c8ada52549a29ee_benefits%20icon3.avif" loading="lazy" alt="B2B SaaS software Webflow template benefits 3" class="icon-height-huge"/>
                                    <div class="spacer-medium"></div>
                                    <div>
                                ...
                                <div class="home1_benefits_card">
                                    <img src="{{ asset('asset_frontend') }}/images/6836a7c5e2fb557112d307fb_benefits%20icon4.avif" loading="lazy" alt="B2B SaaS software Webflow template benefits4" class="icon-height-huge"/>
                                    <div class="spacer-medium"></div>
                                    <div>
