                                ...
                                <div class="p-4">
                                    <div class="avatar-upload mb-3">
                                        <div class="avatar-preview">
                                            <div id="imagePreview" style="background-image: url('{{ Auth::user()->image ? asset('uploads/users/' . Auth::user()->image) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&color=7F9CF5&background=EBF4FF' }}');">
                                            </div>
                                        </div>
