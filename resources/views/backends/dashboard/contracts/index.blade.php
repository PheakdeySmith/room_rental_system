    ...
    <div class="page-container">
        ...
        <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-18 text-uppercase fw-bold mb-0">Contracts Tables</h4>
            </div>
            ...
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                    ...
                    <li class="breadcrumb-item active">Contracts Tables</li>
                </ol>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed">
                        <div class="d-flex flex-wrap justify-content-between gap-2">
                            ...
                            <div>
                                <a href="{{ route('contracts.create') }}" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add Contracts</a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        const contractsData = {!! json_encode(
            $contracts->map(function ($contract) {
                return [
                    $contract->id,
                    $contract->tenant->name ?? 'Unknown',
                    $contract->room->number ?? 'Unknown',
                    $contract->start_date,
                    $contract->end_date,
                    $contract->status,
                    '',
        ...
        clearAndRenderGrid("table-gridjs", {
            ...
            `);
                ...
                <div class="hstack gap-1 justify-content-start">
                    <a href="/contract/${id}" class="btn btn-soft-primary btn-icon btn-sm rounded-circle"><i class="ti ti-eye"></i></a>
                    <a href="/contract/${id}/edit" class="btn btn-soft-success btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-16"></i></a>
                    <button data-id="${id}" type="button" id="sweetalert-params" class="btn btn-soft-danger btn-icon btn-sm rounded-circle delete-contract"><i class="ti ti-trash"></i></button>
                </div>
            `);
                    }
                }
