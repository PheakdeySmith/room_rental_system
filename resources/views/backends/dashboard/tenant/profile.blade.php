    ...
    <div class="mb-3">
        ...
        <div class="profile-card animate-fade-in mb-4">
            <div class="d-flex flex-column flex-md-row align-items-center">
                <img src="https://ui-avatars.com/api/?name={{ Auth::user()->first_name }} {{ Auth::user()->last_name }}&background=47CFD1&color=fff&size=100" 
                     alt="Profile Avatar" class="profile-avatar mb-3 mb-md-0 me-md-4">
                <div class="text-center text-md-start">
                    <h2 class="fw-bold mb-1">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h2>
            ...
            <div class="col-lg-4">
                ...
                <div class="profile-card animate-fade-in mb-4">
                    <div class="section-header">
                        ...
                        <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addPaymentMethodModal">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="payment-method-card">
                            <div class="payment-method-icon {{ $method->type == 'credit_card' ? 'icon-credit-card' : 'icon-bank' }}">
                                <i class="ti ti-{{ $method->type == 'credit_card' ? 'credit-card' : 'building-bank' }}"></i>
                            </div>
                            <div class="payment-method-details">
                                <div class="fw-bold">{{ $method->name }}</div>
                                <div class="text-muted small">{{ $method->masked_number }}</div>
                            </div>
                            <div class="d-flex align-items-center">
                                @if($method->is_default)
                                <span class="badge bg-success-subtle text-success me-2 px-2 py-1 rounded-pill">Default</span>
                                @endif
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#"><i class="ti ti-pencil me-2"></i> Edit</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="ti ti-star me-2"></i> Set as Default</a></li>
                    ...
                    <div class="empty-state mt-3">
                        ...
                        <p class="text-muted">Add a payment method to make rent payments easier.</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    ...
                    <!-- Bank Account Fields (hidden by default) -->
                    ...
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-primary btn-action">Add Payment Method</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Supported formats: PDF, JPG, PNG. Maximum file size: 10MB</div>
                    </div>
                    ...
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-primary btn-action">Upload Document</button>
                    </div>
                </form>
            </div>
        </div>
