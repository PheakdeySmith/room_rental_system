                        ...
                        @forelse ($mainItems as $index => $item)
                            <tr>
                                ...
                                <td data-label="Unit Price">
                                    ${{ number_format($item->lineable?->rate_applied ?? $item->amount, 2) }}</td>
                                <td data-label="Amount" class="text-end">${{ number_format($item->amount, 2) }}</td>
                            </tr>
                        @empty
                            <tr>
                        ...
                        @if ($mainItems->isNotEmpty())
                            <tr class="totals-row">
                                ...
                                <td class="text-end" data-label="Subtotal">
                                    ${{ number_format($mainItems->sum('amount'), 2) }}</td>
                            </tr>
                            <tr class="totals-row">
                                <td colspan="4" class="text-end">Discount</td>
                                <td class="text-end" data-label="Discount">
                                    -${{ number_format(abs($discountItem?->amount ?? 0), 2) }}</td>
                            </tr>
